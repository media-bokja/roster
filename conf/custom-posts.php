...
return [
    ...
    [
        ...
        [
            'label'                           => __('명부', 'roster'),
            'labels'                          => [
                'name'                     => _x('명부', 'roster_profile label name', 'roster'),
                'singular_name'            => _x('명부', 'roster_profile label singular_name', 'roster'),
                ...
                'menu_name'                => _x('명부', 'roster_profile label', 'roster'),
                'filter_items_list'        => _x('명부 목록 필터', 'roster_profile label', 'roster'),
                'filter_by_date'           => _x('날짜로 필터', 'roster_profile label', 'roster'),
                'items_list_navigation'    => _x('', 'roster_profile label', 'roster'),
                'items_list'               => _x('명부 목록', 'roster_profile label', 'roster'),
                'item_published'           => _x('명부 저장됨', 'roster_profile label', 'roster'),
                'item_published_privately' => _x('', 'roster_profile label', 'roster'),
                'item_reverted_to_draft'   => _x('', 'roster_profile label', 'roster'),
                'item_trashed'             => _x('명부 삭제됨', 'roster_profile label', 'roster'),
                'item_scheduled'           => _x('', 'roster_profile label', 'roster'),
                'item_updated'             => _x('명부 갱신됨', 'roster_profile label', 'roster'),
                'item_link'                => _x('', 'roster_profile label', 'roster'),
                'item_link_description'    => _x('', 'roster_profile label', 'roster'),
            ],
            'description'                     => _x('명부 포스트 타입', 'Description of roster_profile', 'roster'),
            'public'                          => false,
            'hierarchical'                    => false,
